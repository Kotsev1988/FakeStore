...
class StoreFragment : MvpAppCompatFragment(), StoreView, BackPressedListener {
    ...
    private var listDelegates =
        listOf(LocationAndFilter("", null), headerProduct, Category(Categories(), null),
    ...
    override fun init() {
        ...
        listDelegates = listOf(LocationAndFilter("", presenter.filterClick),
            headerProduct,
    ...
    override fun setLocation(city: String) {
        ...
        println("SetLocation "+city)
        mainAdapter.submitList(listOf(LocationAndFilter(city, presenter.filterClick),
            headerProduct,
            Category(Categories(), presenter.listCategory),
            Search(arrayListOf(), presenter.searchClick),
            headerCategory,
